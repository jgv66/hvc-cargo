module.exports = {
    ...
    upClientes: function(sql, body) {
        ...
        const query = `
                ...
                --
                select cast(1 as bit) as resultado, cast(0 as bit) as error, 'Grabado exitosamente!'
                as mensaje;
                --
                end
                else begin
    ...
    borrarEncomienda: function(sql, body) {
        ...
        const query = `
                ...
                --
                select cast(1 as bit) as resultado, cast(0 as bit) as error, 'Borrado exitosamente!'
                as mensaje;
                --
                end
                else begin
                    --
                    select cast(0 as bit) as resultado, cast(1 as bit) as error, 'La encomienda no existe!'
                as mensaje;
                --
                end;
                end
